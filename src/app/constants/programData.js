export const programFeatures = [
    ...
    {
      title: "Personalized Learning Paths with AI Avatars",
      description:
    ...
    {
      title: "Collaborative Learning Networks",
      description:
    ...
    {
      title: "Ethics and Sustainability in Leadership",
      description:
...
export const testYourselfLinks = [
  ...
  export const initiatives = [
    ...
    {
      title: "The Innovation Nations Games (TING) Olympics",
      description:
    ...
    {
      title: "TING Future of Work Portal",
      description:
    ...
    {
      title: "TING Thinking Method Workshops",
      description:
